...
The working codes is available via my Github, check out the [symfony-rest-sample/v7](https://github.com/hantsy/symfony-rest-sample/tree/v7), please provides feedback.
