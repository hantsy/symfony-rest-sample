...
```
You will find the Symfony test listener is removed by this script, because `listener` is not a valid element in PHPUnit 10. We are waiting a new replacement in a further version.
